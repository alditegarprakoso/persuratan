<script>
    $(document).ready(function() {
        ...
        $('#mytable').DataTable({
            ...
            "ajax": {
                url: "<?php echo base_url("barangmasuk/getBarangMasuk") ?>",
                type: 'post',
                dataType: 'json'
            },
            "oLanguage": {
    ...
    $('#mytable').on('click', '.delete_barang_masuk', function() {
        let id = $(this).data('id');
        $.ajax({
            url: "<?php echo base_url("barangmasuk/getDataById") ?>",
            type: 'post',
            dataType: 'json',
            data: {
                "id": id
    ...
    $("#hapus").submit(function(e) {
        ...
        // delete data
        $.ajax({
            url: "<?php echo base_url("barangmasuk/delete") ?>",
            type: 'post',
            dataType: 'json',
            data: {
                "id_hapus3": id
