<h1 class="text-gray-800 mb-4">Data Satuan</h1>
<?= $this->session->flashdata('message'); ?>
<div class="card mb-5">
    <div class="card-header">
        <strong class="text-primary">Data Satuan</strong>
    </div>
    <div class="card-body">
        <p><a href="<?= base_url('satuan/add'); ?>" class="btn btn-primary btn-sm">Add Satuan</a></p>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        <label class="col-sm-4 ">Satuan Name :</label>
                        <div class="col-sm-8">
