<h1 class="text-gray-800 mb-4">Laporan Barang Keluar</h1>
...
<div class="card shadow mb-4">
    ...
    <div class="collapse show" id="filterByTanggal">
        <div class="card-body">
            <form action="<?= base_url('barangkeluar/tanggalFilter'); ?>" method="POST" target="_blank">
...
<div class="card shadow mb-4">
    ...
    <div class="collapse show" id="filterByBulan">
        <div class="card-body">
            <form action="<?= base_url('barangkeluar/bulanFilter'); ?>" method="POST" target="_blank">
                <div class="form-group">
...
<div class="card shadow mb-4">
    ...
    <div class="collapse show" id="filterByTahun">
        <div class="card-body">
            <form action="<?= base_url('barangkeluar/tahunFilter'); ?>" method="POST" target="_blank">
                <div class="form-group">
                    <label for="tahun">Tahun</label>
                    <select class="form-control" id="tahun" name="tahun" required>
                        <?php foreach ($dataTahun as $tahun) { ?>
