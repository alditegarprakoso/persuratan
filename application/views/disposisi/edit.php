<h1 class="h3 mb-4 text-gray-800">Edit Data Disposisi</h1>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?= base_url('home/editDisposisi?id=' . $data['id']); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kepada" id="kepada" class="form-control" value="<?= set_value('kepada') ? set_value('kepada') : $data['kepada']; ?>" required>
